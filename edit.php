          ...
          <?php foreach ($tweets as $tweet_each) { ?>
            <div class="msg">
              <img src="member_picture/<?php echo $tweet_each['picture_path']; ?>" width="100" height="100">
                ...
                <p>
                  つぶやき : <br>
                  <textarea name="tweet" class="form-control"><?php echo $tweet_each['tweet']; ?></textarea>
                </p>
                <p class="day">
                  <?php echo $tweet_each['created']; ?>
                <!-- [<a href="#" style="color: #F33;" >削除</a>] -->
                <!-- javascriptで最終確認のポップアップを作る -->
                <!-- [<a href="#" style="color: #F33;" onclick="return confirm('本当に削除しますか?');">削除</a>] -->
                </p>
